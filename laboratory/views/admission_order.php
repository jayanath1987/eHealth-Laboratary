    ...
    if (!empty($orederd_test_list)) {
        ...
        foreach ($orederd_test_list as $key => $value) {
            ...
            if ($value["Status"] == "Pending") {
                ...
                if ($value["Status"] == "Updated") {  // Received from auto analyzers 
                    echo '<td>';
                    echo '<input id="' . $value["LAB_ORDER_ITEM_ID"] . '"  name="' . $value["LAB_ORDER_ITEM_ID"] . '"   value="' . $value["TestValue"] . '" cols=40 rows=4>';
                    echo '</td>';
                    if ($value["RefValue"]) {
...
?>
        ...
        <div class="col-md-2">
            ...
            <!-- ALLERGY-->
            <div class="panel  panel-danger"  style="padding:2px;margin-bottom:1px;width:300px" >
                <div class="panel-heading" ><b>Allergies</b></div>

            </div>	
            <!-- END ALLERGY-->
            <div class="panel  panel-info"  style="padding:2px;margin-bottom:1px;width:300px" >
...
if (isset($patient_previous_lab_list)) {
    foreach ($patient_previous_lab_list as $key => $value) {
        ...
        echo $value["TestGroupName"];
        echo '&nbsp&nbsp&nbsp&nbsp&nbsp';
        echo '<a href="'.site_url("laboratory/process_result/".$value["LAB_ORDER_ID"]).'?CONTINUE=search/adm_lab_orders" target="_blank">[OPEN]</a>';
        echo '<br>';
    }
}
?>
                        ...
                        <div class="panel  panel-info"  style="padding:2px;margin-bottom:1px;width:300px" >
                <div class="panel-heading" ><b>Histograms For this Order</b></div>
        </div>
    </div>
</div>
