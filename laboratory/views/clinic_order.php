...
<div class="container" style="width:95%;">
	...
	<div class="col-md-10 " >
		...
		<div class="panel panel-default  "  style="padding:2px;margin-bottom:1px;" >
			<div class="panel-heading" ><b>Clinic lab order</b></div>
			...
			<?php 
					echo '<table class="table table-condensed table-hover" style="margin-bottom:0px;">';
						echo '<tr>';
							echo '<td>';
								echo 'Clinic : <b id="opd_complaint">'.$clinic_info["name"].'</b>';
							echo '</td>';
							echo '<td>';
						...
						echo '</tr>';
					echo '</table>';	
					echo '<br><center><a href="'.site_url("clinic/visit_view/".$clinic_patient_id).'">Back to clinic visit</a></center>';	
					echo '<div>';
					echo '<table class="table table-condensed table-hover" style="margin-bottom:0px;">';
					if (isset($episode_lab_order)){
						...
						foreach($episode_lab_order as $key=>$value) {
							echo '<tr>';
								...
								echo '</td>';
								echo '<td>';
								echo ' <a href="'.site_url("laboratory/order/".$value["LAB_ORDER_ID"]."/?CONTINUE=laboratory/clinic_order/".$clinic_patient_id).'">[Open]&nbsp;</a>';
								echo ' <a target="_blank" href="'.site_url("laboratory/order/".$value["LAB_ORDER_ID"]."/?CONTINUE=laboratory/clinic_order/".$clinic_patient_id).'">[Print]&nbsp;</a>';
								echo ' <a  href="'.site_url("laboratory/process_result/".$value["LAB_ORDER_ID"]."/?CONTINUE=laboratory/clinic_order/".$clinic_patient_id).'">[Enter result]</a>';
								echo '</td>';
							echo '<tr>';
						}
					}
			...
			?>" >
				...
				?> 
				<input type="hidden" name="Dept" id="Dept" value="CLN">
				<input type="hidden" name="GroupName" id="GroupName" value="">
				<input type="hidden" name="Priority" id="Priority" value="">
				<input type="hidden" name="OPDID" id="OPDID" value="<?php echo $clinic_patient_id; ?>">
										...
										echo '<center>';
											if (isset($oreder_info)&&($oreder_info["Status"]=="Available")){
												...
												if ($mode=="process"){
													...
													echo '&nbsp;&nbsp;<a href="'.site_url($_GET["CONTINUE"]).'">Back to visit</a>';
												}	
											}
										echo '</center>';
									}
